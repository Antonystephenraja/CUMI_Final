...
//  }
  return (
    <div className="flex flex-col rounded-md">
      ...
      {/* <div className="">
        <div className="overflow-x-auto inline-block sm:w-full">
          <div className="overflow-hidden table_h lg:h-[40vh] overflow-y-auto  scrollbar-hide">
            <table className="bg-[#2d2d2d] border">
              <thead className="bg-[#f77f50e5] border-b static">
                <tr>
                  <th className="text-sm sm:font-medium text-white">
                    DeviceId
